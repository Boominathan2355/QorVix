...
import { MemoryIcon, RefreshIcon, HardDriveIcon, LayersIcon, ZapIcon } from '../components/icons/Icons';
  ...
  return (
    <div className="p-6 md:p-8 max-w-7xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div className="space-y-1">
          ...
          <h2 className="text-2xl font-bold text-slate-100 tracking-tight flex items-center gap-2">
            <MemoryIcon size={24} className="text-amber-400" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {/* Tier 0: GPU VRAM */}
        <Card glass className="p-6 space-y-4 border-slate-800">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <span className="text-[11px] font-mono text-teal-400 uppercase font-bold tracking-wider">
                TIER 0 • LOW LATENCY
              </span>
              <h3 className="font-bold text-slate-100 text-base">GPU VRAM</h3>
            </div>
        ...
        <Card glass className="p-6 space-y-4 border-slate-800">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              <span className="text-[11px] font-mono text-sky-400 uppercase font-bold tracking-wider">
                TIER 1 • SYSTEM RAM
              </span>
              <h3 className="font-bold text-slate-100 text-base">Host Memory</h3>
            </div>
          ...
          <div className="space-y-2">
            <div className="h-3 w-full bg-slate-950 rounded-full overflow-hidden p-0.5 border border-slate-800">
              <div
                className="h-full bg-gradient-to-r from-sky-500 to-indigo-400 rounded-full transition-all duration-500"
                style={{ width: `${ramPct}%` }}
              />
            </div>
            <div className="flex justify-between text-xs font-mono text-slate-400">
        ...
        <Card glass className="p-6 space-y-4 border-slate-800">
          <div className="flex items-center justify-between">
            <div className="space-y-0.5">
              ...
              <h3 className="font-bold text-slate-100 text-base">NVMe Storage</h3>
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card glass className="p-6 space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center text-xs font-mono">
              <span className="text-slate-400">Page Utilization</span>
              <span className="text-teal-300 font-bold">{stats.kvPagesUsed} / {stats.kvPagesTotal} pages ({kvPct}%)</span>
            </div>
            <div className="h-2.5 w-full bg-slate-950 rounded-full overflow-hidden p-0.5 border border-slate-800">
              <div className="h-full bg-teal-400 rounded-full" style={{ width: `${kvPct}%` }} />
            </div>
          </div>

          <div className="grid grid-cols-2 gap-3 pt-2 text-xs font-mono">
            <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800">
              <span className="text-slate-500 block text-[10px]">PAGE SIZE</span>
              <span className="text-slate-200 font-bold">16 Tokens / Page</span>
            </div>
            <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800">
              <span className="text-slate-500 block text-[10px]">RADIX TREE SHARING</span>
              <span className="text-emerald-400 font-bold">Zero-Copy Active</span>
            </div>
          </div>
        </Card>
        ...
        <Card glass className="p-6 space-y-4">
          <CardTitle className="text-sm font-semibold text-slate-200 flex items-center gap-2">
            <ZapIcon size={18} className="text-amber-400" />
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center text-xs font-mono">
              ...
              <span className="text-emerald-400 font-bold">{stats.fragmentationPct}% (Optimal)</span>
            </div>
            <div className="h-2.5 w-full bg-slate-950 rounded-full overflow-hidden p-0.5 border border-slate-800">
              <div className="h-full bg-emerald-400 rounded-full" style={{ width: `${stats.fragmentationPct * 5}%` }} />
            </div>
          </div>

          <div className="grid grid-cols-2 gap-3 pt-2 text-xs font-mono">
            <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800">
              <span className="text-slate-500 block text-[10px]">SLAB CLASS BUCKETS</span>
              <span className="text-slate-200 font-bold">64B to 64MB Powers-of-2</span>
            </div>
            <div className="p-3 rounded-xl bg-slate-950/60 border border-slate-800">
              <span className="text-slate-500 block text-[10px]">ALLOCATION OVERHEAD</span>
              <span className="text-teal-400 font-bold">&lt; 1.2% Memory Loss</span>
            </div>
          </div>
        </Card>
      </div>
